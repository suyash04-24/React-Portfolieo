	...
	<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-coolGray-400">
		...
		<div className="flex flex-col justify-center pt-6 lg:pt-0">
			<div className="flex justify-center space-x-4">
				...
				<a href="https://github.com/suyash04-24" title="GitHub" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10  bg-[#EF404A]">
				...
				<a href="https://www.linkedin.com/in/suyash-kakasaheb-lagad/" title="Linkedin" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10  bg-[#EF404A]">
